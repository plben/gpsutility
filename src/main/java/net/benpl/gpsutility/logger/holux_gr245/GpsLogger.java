...
public final class GpsLogger extends net.benpl.gpsutility.logger.GpsLogger {
     ...
     */
    private static final String LOGGER_ID = "GR245";
    ...
    protected void serialPortReady() {
        if (loggerTask instanceof LoggerTask.Connect) {
            ...
            loggerThread.enqueueSendJob(
                    ...
                    new SendJob(this, "Query ByDist", "PMTK182,2,4", "PMTK182,3,4"), // Query HoluxGR245 for interval (in 0.1 meter) of ByDistance
                    new SendJob(this, "Query BySpeed", "PMTK182,2,5", "PMTK182,3,5"), // Query HoluxGR245 for interval (in 0.1 km/h) of BySpeed
                    new SendJob(this, "Query RcdMethod", "PMTK182,2,6", "PMTK182,3,6"), // Query HoluxGR245 for record method. (Overlap or StopOnFull)
                    new SendJob(this, "Query LoggerState", "PMTK182,2,7", "PMTK182,3,7"), // Query HoluxGR245 for log status. (Start/Stop)
                    new SendJob(this, "Query RcdAddr", "PMTK182,2,8", "PMTK182,3,8"), // Query HoluxGR245 for record address. (next write)
                    new SendJob(this, "Query flashID", "PMTK182,2,9", "PMTK182,3,9"), // Query HoluxGR245 for flash ID
                    new SendJob(this, "Query RcdTotal", "PMTK182,2,10", "PMTK182,3,10"), // Query HoluxGR245 for total records
                    new SendJob(this, "Query FailSectors", "PMTK182,2,11", "PMTK182,3,11"), // Query HoluxGR245 for FailSector in flash
                    new SendJob(this, "Query MtkVersion", "PMTK182,2,12", "PMTK182,3,12", true) // Query HoluxGR245 for MTK hardware version
                    // FIXME: Need GR-245 specific NMEA commands
...
//                    if (configPaneController != null) configPaneController.setRcdMethod(rcdMethod);
    ...
    protected boolean preDisconnect() {
        if (loggerState == STATE_USB_MODE) {
            ...
            loggerThread.enqueueSendJob(
                    new SendJob(this, "Exit USB-Mode", "PHLX827", "PHLX860", true) // Transit Holux GR-245 out from USB_MODE
            );
            return false;
        } else {
            return true;
    ...
    protected void uploadTrack() {
        ...
        if ((loggerStatus & 0x0002) != 0) {
            ...
            jobs.add(new SendJob(this, "Query LoggerState", "PMTK182,2,7", "PMTK182,3,7")); // Query HoluxGR245 for log status.
        }
        jobs.add(new SendJob(this, null, "PMTK182,2,8", "PMTK182,3,8")); // Query HoluxGR245 for record address. (next write)

        // Send these NMEA commands to HOLUX GR-245
