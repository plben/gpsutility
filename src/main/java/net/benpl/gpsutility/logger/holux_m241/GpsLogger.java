...
/**
 * Holux M-241 GPS Logger entity inherited from {@link net.benpl.gpsutility.logger.GpsLogger}.
 */
public final class GpsLogger extends net.benpl.gpsutility.logger.GpsLogger {
     ...
     */
    private static final String LOGGER_ID = "GR241";
    ...
    protected void serialPortReady() {
        if (loggerTask instanceof LoggerTask.Connect) {
            ...
            loggerThread.enqueueSendJob(
                    ...
                    new SendJob(this, "Query FmtReg", "PMTK182,2,2", "PMTK182,3,2"), // Query HoluxM241 for log format register
                    new SendJob(this, "Query BySec", "PMTK182,2,3", "PMTK182,3,3"), // Query HoluxM241 for interval (in 0.1 second) of BySEC
                    new SendJob(this, "Query ByDist", "PMTK182,2,4", "PMTK182,3,4"), // Query HoluxM241 for interval (in 0.1 meter) of ByDistance
                    new SendJob(this, "Query BySpeed", "PMTK182,2,5", "PMTK182,3,5"), // Query HoluxM241 for interval (in 0.1 km/h) of BySpeed
                    new SendJob(this, "Query RcdMethod", "PMTK182,2,6", "PMTK182,3,6"), // Query HoluxM241 for record method. (Overlap or StopOnFull)
                    new SendJob(this, "Query LoggerState", "PMTK182,2,7", "PMTK182,3,7"), // Query HoluxM241 for log status. (Start/Stop)
                    new SendJob(this, "Query RcdAddr", "PMTK182,2,8", "PMTK182,3,8"), // Query HoluxM241 for record address. (next write)
                    new SendJob(this, "Query flashID", "PMTK182,2,9", "PMTK182,3,9"), // Query HoluxM241 for flash ID
                    new SendJob(this, "Query RcdTotal", "PMTK182,2,10", "PMTK182,3,10"), // Query HoluxM241 for total records
                    new SendJob(this, "Query FailSectors", "PMTK182,2,11", "PMTK182,3,11"), // Query HoluxM241 for FailSector in flash
                    new SendJob(this, "Query MtkVersion", "PMTK182,2,12", "PMTK182,3,12"), // Query HoluxM241 for MTK hardware version
    ...
    protected void uploadTrack(String filePath, List<ExportType> exportTypes) {
        ...
        if ((loggerStatus & 0x0002) != 0) {
            ...
            jobs.add(new SendJob(this, "Query LoggerState", "PMTK182,2,7", "PMTK182,3,7")); // Query HoluxM241 for log status.
        }
        jobs.add(new SendJob(this, null, "PMTK182,2,8", "PMTK182,3,8")); // Query HoluxM241 for record address. (next write)
